  ...
  return (
    ...
    <div className = {`${outfit.className} text-lg flex flex-col items-center`}>
      ...
      <Form className = "flex flex-col items-center bg-white shadow-xl rounded-2xl p-10" action = {signup}>
        ...
        <button className = "my-2 border rounded-sm w-full mt-2 border border-gray-800 hover:bg-gray-800 hover:text-white disabled:bg-gray-500 disabled:border-gray-500 disabled:hover:bg-gray-500 disabled:text-white rounded-md p-2 transition-all" type = "submit" disabled = {isTurnstileLoading || passwordStrength < 3}>
