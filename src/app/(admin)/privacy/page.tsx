    ...
    <div className="sm:w-xl lg:w-3xl xl:w-4xl space-y-4 large-text">
      ...
      <section className="space-y-2">
        ...
        <p className="detail-text">
          ...
          <strong>provide services and goods, including delivery</strong>:
        </p>
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc pl-5 space-y-2 detail-text">
          <li>
            ...
            for copies of your personal information. You can request other
          ...
          <li>
            ...
            ask us to correct or delete personal information you think is
          ...
          <li>
            <strong>Your right to withdraw consent</strong> - When we use
        ...
        <div className="space-y-2">
          ...
          <p className="detail-text">
            ...
            <strong>provide services and goods</strong> are:
          </p>

          <ul className="list-disc pl-5 space-y-1 detail-text">
            <li>
              <strong>Legitimate interests</strong> - {`we're`} collecting or
              using your information because it benefits you, our organisation
      ...
      <section className="space-y-2">
        ...
        <div className="space-y-1 detail-text">
          ...
          <p>
            <strong>Helpline number:</strong> 0303 123 1113
          </p>
          <p>
