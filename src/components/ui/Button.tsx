...
export default function Button(props: ButtonComponentProps) {
  ...
  const styles = cn(
    'mt-2 inline-flex w-full items-center justify-center rounded-md border px-4 py-2 text-center font-medium transition-all ease-in-out',
    !isDisabled &&
      'border-[var(--foreground)] bg-[var(--background)]/50 text-[var(--foreground)] hover:border-[var(--foreground)] hover:bg-[var(--foreground)]/90 hover:text-[var(--background)]',
    isDisabled &&
